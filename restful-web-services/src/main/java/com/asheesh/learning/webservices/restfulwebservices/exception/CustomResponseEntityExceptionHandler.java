...
public class CustomResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public final ResponseEntity<Object> handleUserNotFoundException(UserNotFoundException ex, WebRequest request) {
		...
		ResponseException exception = new ResponseException(new Date(), "User Not Found",
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		ResponseException exception = new ResponseException(new Date(), "Input Validation Failed", ex.getMessage());

		return new ResponseEntity<>(exception, headers, HttpStatus.NOT_FOUND);
	}
}
